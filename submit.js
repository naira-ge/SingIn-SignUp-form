...
const usernameEl = form.element['username'];
const emailEl = form.element['email'];
const passwordEl = form.element['password'];
const confirmPasswordEl = form.element['confirm-password'];
    ...
    if (isFormValid) {
        ...
        fetch('https://jsonplaceholder.typicode.com/posts', {
          ...
          .then((doc) => {
            ...
            reform.parentNode.replaceChild(result, reform);
        ...
        Array.from(reform.elements).forEach((field) => (field.disabled = true));
